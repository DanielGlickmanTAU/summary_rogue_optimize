...
class UnsupervisedSeq2SeqTrainingArguments(Seq2SeqTrainingArguments):
    ...
    train_filter_on: str = field(default='train')  # options: train,validation, both
    ...
    quit_after_generating_summaries: bool = field(default=False)
...
def parse_generation_args():
    ...
    parser = HfArgumentParser(
        (GeneratorModelArguments, DataTrainingArguments, UnsupervisedSeq2SeqTrainingArguments))
